  ...
  return (
    <main>
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-12 px-4 py-16 md:px-6">
        <aside className="rounded-xl border border-primary bg-primary/10 p-5"><h2 className="font-bold">Wymagane uzupełnienie przed uruchomieniem sprzedaży</h2><p className="mt-2 text-sm leading-relaxed text-muted-foreground">Dane firmy nie zostały jeszcze potwierdzone. Uzupełnij je w panelu administratora i przekaż poniższe dokumenty prawnikowi do końcowej weryfikacji. Ta strona nie zastępuje indywidualnej porady prawnej.</p></aside>
        ...
        <section id="cookies" className="scroll-mt-24"><h2 className="font-sans text-3xl font-black uppercase">Pliki cookies</h2><div className="mt-4 flex flex-col gap-4 leading-relaxed text-muted-foreground"><p>Serwis używa niezbędnych cookies do zapamiętania wyboru prywatności i obsługi bezpiecznej sesji administratora. Nie wymagają one zgody, ponieważ są konieczne do działania serwisu.</p><p>Vercel Analytics jest uruchamiane dopiero po wybraniu opcji „Akceptuję analitykę”. Zgodę można w każdej chwili zmienić przyciskiem „Ustawienia cookies” widocznym na stronie.</p></div></section>
