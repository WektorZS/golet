  ...
  return (
    <footer className="bg-foreground text-background">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-4 md:px-6">
        ...
        <div className="flex flex-col gap-3 text-sm"><h2 className="font-mono text-xs font-bold uppercase tracking-widest text-primary">Kontakt</h2><a className="flex items-center gap-2" href={phoneHref}><Phone aria-hidden="true" />{phone}</a><a className="flex items-center gap-2" href={`mailto:${email}`}><Mail aria-hidden="true" />{email}</a></div>
      </div>
