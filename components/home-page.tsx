    ...
    <main>
      ...
      <section id="wyjazdy" className="scroll-mt-8 bg-background px-4 py-20 md:px-6 md:py-28">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="Kalendarz emocji" title="Najbliższe wyjazdy" intro="Wybierz gotowy pakiet i zajmij miejsce na trybunach największych stadionów Europy." />
