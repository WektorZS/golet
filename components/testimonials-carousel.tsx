  ...
  return (
    <>
        ...
        <CarouselContent className="-ml-4">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <blockquote className="group relative flex h-full min-h-[300px] flex-col overflow-hidden rounded-xl border border-white/[0.09] bg-white/[0.045] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/35 hover:bg-white/[0.065] md:p-7">
      ...
      {selected && (
        ...
        >
          <div className="relative max-h-[90svh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-white/10 bg-[#111315] shadow-2xl">
            ...
            <div className="p-6 pt-16 md:p-10 md:pt-10">
              ...
              <div className="mt-9 flex items-center justify-between border-t border-white/10 pt-6">
                ...
                <button
                  type="button"
                  onClick={() => setSelected(null)}
                  className="text-xs font-black uppercase tracking-[0.12em] text-primary transition-opacity hover:opacity-70"
                >
                  Zamknij
                </button>
              </div>
